...
太长不看：Deepseek R1跟V3是最佳，其次 4o，其他不行。而且GPT的思考类模型反而明显不如 4o
...
论作词，不解释词牌名，Deepseek R1跟V3是最佳，其次 4o，其他不行；若解释，其他模型也有所提升，除了GPT的思考类模型

不论哪种情况，GPT的思考类模型反而明显不如 4o

实际上，作诗也类似。Deepseek真是最懂中文的大模型了
